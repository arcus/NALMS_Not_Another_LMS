<p>Here is your assigned peony pathway. We are working to make sure your progress shows up in this email in the future, but for now you can follow the link at the bottom of this email to see you current status and update your progress.</p>
<table>
<tbody>
<tr>
...
<tr>
    <td><strong>Getting Started with R</strong></td>
    <td></td>
    <td></td>
    </tr>
<tr>
...
<tr>
    <td><strong>Pattern Matching in Text</strong></td>
    <td></td>
    <td></td>
    </tr>
<tr>
...
<tr>
    <td><strong>Working with Databases</strong></td>
    <td></td>
    <td></td>
    </tr>
<tr>
...
<p></p>
<p>As you continue trying out modules, you can check and update your progress in this form:<br />[survey-link:peony_pathway:Progress on the peony pathway][new-instance]</p>
<p>You can update this as many times as you want, either by following the link in this email, or by pasting the following url into your browser:<br />[survey-url:peony_pathway][new-instance]</p>
