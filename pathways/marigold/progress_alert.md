<p>Here is your assigned marigold pathway. We are working to make sure your progress shows up in this email in the future, but for now you can follow the link at the bottom of this email to see you current status and update your progress.</p>
<table>
<tbody>
<tr>
...
<p></p>
<p>As you continue trying out modules, you can check and update your progress in this form:<br />[survey-link:marigold_pathway:Progress on the marigold pathway][new-instance]</p>
<p>You can update this as many times as you want, either by following the link in this email, or by pasting the following url into your browser:<br />[survey-url:marigold_pathway][new-instance]</p>
