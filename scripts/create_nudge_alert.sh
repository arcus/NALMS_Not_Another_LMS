...
alert_csv=pathways/$pathway/nudge_alert.csv 
...
echo ',Inactive nudge '$pathway' pathway,LOGIC,,ANY,[pathway] = "'$pathway'" and datediff([survey-date-completed:test_color_pathway][last-instance], "today", "d", "ymd") > 14 AND [stop_emails] <> "1" AND [complete] <> "2", "today", "d", "ymd") > 14 AND [stop_emails] <> "1" AND [complete] <> "2",Y,RECORD,DATE,,,,,,,,8/21/2023  9:00:00 AM,SCHEDULE,,14,DAYS,,12/1/2023  9:00:00 AM,EMAIL,,dart@chop.edu,[survey-participant-email],,,,Log back in and keep learning!,"'$(cat pathways/$pathway/nudge_alert.md)'",,{},{},Y,,,N' >>$alert_csv
